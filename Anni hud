...
local RecorderInit = loadstring(game:HttpGet("https://raw.githubusercontent.com/Ceepizz/library/refs/heads/main/recorder"))()
RecorderInit({
    Window = Window,
        ...
        while Globals.AutoGatling do
            if GameState == "GAME" then
                if not GatlingExecuted then
                    ...
                    task.spawn(function()
                        pcall(function()
                            getgenv().SCRIPT_KEY = "b0f0537c-5607-4dda-892c-77b17113d051"
loadstring(game:HttpGet("https://api.jnkie.com/api/v1/luascripts/public/571d41d522febb16db001a6867d5b9c3301372d1a8e3cde5b5a5190da7aee68d/download"))()
                        end)
                    end)
                end
            else
